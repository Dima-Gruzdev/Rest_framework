...
Инструкция по развёртыванию проекта на удалённом сервере (например, Yandex Cloud).

---

### 1. Создание виртуальной машины (Yandex Cloud)
...
2. Создайте ВМ:
   ...
   - vCPU: 2, RAM: 4 ГБ
   - Объём диска: 20 ГБ
3. В поле **"SSH-ключ"** вставьте содержимое вашего публичного ключа (`~/.ssh/id_ed25519.pub`)
4. Запомните публичный IP-адрес ВМ
